-- Egg & Ice Sales Monitoring System Database Schema
-- Database Name: egg_ice_db

CREATE DATABASE IF NOT EXISTS `egg_ice_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `egg_ice_db`;
