...
(1, 'Store Owner', 'admin', '$2y$10$ojpKUnjj8bm8hwKPjXPI8eT9ppLP2BRDMO0DkuMxvgwdeqD0VAr2i', 'admin'),
(2, 'Juan Dela Cruz', 'staff', '$2y$10$TczlR8lUj8kbGXAuj6KDrO0WqKq3DaUo/.jTQIlrHRtSAYA0zpG8O', 'staff');
...
INSERT INTO `product_variants` (`id`, `product_id`, `variant_name`, `quantity`, `price`) VALUES
(1, 1, 'Small', 1, 7.00),
(2, 1, 'Medium', 1, 8.00),
(3, 1, 'Large', 1, 9.00),
(4, 2, 'Default', 1, 20.00);
