                ...
                <?php foreach ($products as $prod): ?>
                    <div class="border border-brand-100 rounded-md p-4 space-y-2 hover:bg-brand-50 transition-colors">
                        ...
                        <div class="pt-2 border-t border-brand-100">
                            <a href="/staff/product-edit.php?id=<?= $prod['id']; ?>" class="block px-3 py-2 bg-brand-100 hover:bg-brand-200 text-brand-500 rounded-sm text-sm font-semibold transition-colors text-center">Edit Product</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
                                ...
                                <tr class="border-b border-brand-100 hover:bg-brand-50 transition-colors">
                                    ...
                                    <?php if ($i === 0): ?>
                                        <td rowspan="<?= $vCount; ?>" class="px-6 py-4 text-right border-l border-brand-200 align-middle">
                                            <a href="/staff/product-edit.php?id=<?= $prod['id']; ?>" class="inline-flex items-center px-4 py-2.5 bg-brand-100 hover:bg-brand-200 text-brand-500 rounded-sm text-sm font-semibold transition-colors">
                                                Edit Product
                                            </a>
                                        </td>
                                    <?php endif; ?>
